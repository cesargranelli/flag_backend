...
public interface CompetitionEnrollmentWindowApi {
    ...
    CompetitionEnrollmentWindowResponse openWindow(
    ...
    @PreAuthorize(SecurityExpressions.ADMIN_OR_ORGANIZER)
    CompetitionEnrollmentWindowResponse closeWindow(
            @Parameter(description = "ID da competição") @PathVariable UUID competitionId);
    ...
    CompetitionEnrollmentWindowResponse findByCompetitionId(
            @Parameter(description = "ID da competição") @PathVariable UUID competitionId);
    ...
    List<CompetitionEnrollmentWindowResponse> listOpenWindows();
}
