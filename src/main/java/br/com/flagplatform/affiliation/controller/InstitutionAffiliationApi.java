...
import br.com.flagplatform.affiliation.dto.AffiliationWindowResponse;
import br.com.flagplatform.affiliation.dto.CreateAffiliationWindowRequest;
...
public interface InstitutionAffiliationApi {
    ...
    AffiliationResponse requestAffiliation(
    ...
    List<AffiliationResponse> listByInstitution(@PathVariable UUID institutionId);
    ...
    List<AffiliationResponse> listByOrganization(
    ...
    @PreAuthorize(SecurityExpressions.ORGANIZATION_WRITE)
    AffiliationWindowResponse openWindow(
            @PathVariable UUID organizationId,
            @Valid @RequestBody CreateAffiliationWindowRequest req,
            Authentication authentication);
    ...
    @PreAuthorize(SecurityExpressions.ORGANIZATION_WRITE)
    AffiliationWindowResponse closeWindow(
            @PathVariable UUID organizationId,
    ...
    List<AffiliationWindowResponse> listWindows(@PathVariable UUID organizationId);
    ...
    List<AffiliationWindowResponse> listOpenWindows();
}
